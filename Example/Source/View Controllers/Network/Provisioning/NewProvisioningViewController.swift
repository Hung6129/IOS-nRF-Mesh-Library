//
//  NewProvisioningViewController.swift
//  nRF Mesh
//
...
class NewProvisioningViewController: UIViewController {
...
extension NewProvisioningViewController: OobSelector {

}

private extension NewProvisioningViewController {
...
extension NewProvisioningViewController: GattBearerDelegate {
...
extension NewProvisioningViewController: ProvisioningDelegate {
    ...
    case let .provideStaticKey(callback: callback):
      self.dismissStatusDialog() {
        ...
        self.presentTextAlert(title: "Static OOB Key", message: message,
                              type: .key16Required, cancelHandler: nil) { hex in
...
extension NewProvisioningViewController: SelectionDelegate {
...
extension NewProvisioningViewController : MeshNetworkDelegate {
...
extension  NewProvisioningViewController {
  // MARK: - Implementation
    ...
    case .Bindkey:/// Bind key for models supported
      ...
      case .Start:
        ...
        if(ElementIdx < elements.count) {
          ...
          if(ModelIdx < models.count) {
            self.model = models[ModelIdx]
...
// MARK: - Longpress
extension NewProvisioningViewController: UIGestureRecognizerDelegate {
